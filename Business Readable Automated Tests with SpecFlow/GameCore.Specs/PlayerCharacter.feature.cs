...
#line hidden
        ...
        [Xunit.FactAttribute(DisplayName="Taking no damage when hit does\'t affect health")]
        [Xunit.TraitAttribute("FeatureTitle", "PlayerCharacter")]
        [Xunit.TraitAttribute("Description", "Taking no damage when hit does\'t affect health")]
        public virtual void TakingNoDamageWhenHitDoestAffectHealth()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Taking no damage when hit does\'t affect health", null, ((string[])(null)));
#line 7
